...
describe('LoopPanel', () => {
  ...
  it('renders one explicit workflow canvas without an inner workflow tab strip', () => {
    ...
    const workflowState = loopPanelStateForWorkflow(state, 'wf-a')
    ...
    expect(loopWorkflowPaneTitle(state, 'wf-a')).toBe('Workflow A')
  ...
  it('keeps a canonical workflow pane when its source currently has no rows', () => {
    ...
    const workflowState = loopPanelStateForWorkflow(state, 'wf-empty')
