...
KANBAN_GUIDANCE = (
    ...
    "3. **Ask foreground for live decisions.** For product/scope/architecture/"
    ...
    "and stop. State concrete blocker evidence neutrally; do not classify it as user, foreground, or orchestrator. "
