...
KANBAN_GUIDANCE = (
    ...
    "concrete blocker; do not classify it as user, foreground, or "
    "orchestrator. Route after review.\n"
    ...
    "reviewer can approve, route follow-up work, or request changes. Reviewing-then-"
